...
export const metadata: Metadata = {
  title: "HopIn | SignUp",
  description: "Sign up page for Hopin Webapp",
};
...
const SignUp: React.FC = () => {
  return (
    <DefaultLayout>
      ...
      <div className="mt-9 mb-9 min-h-screen flex items-center justify-center dark:bg-gray-900">
              ...
              <form>
                ...
                <div className="mb-5">
                  <input
                    ...
                    className="placeholder-gray-500 w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>
